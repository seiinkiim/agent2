...
----
러닝 동호회나 마라톤에서 달릴 때 어떤 느낌의 운동화를 신고 싶으신가요?
---
...
-아래의 질문을 출력하기 전에 먼저 "알겠습니다" 라고 한 뒤에 아래의 질문을 출력해세요.
----
러닝할 때 나를 가장 돋보이게 하는 신발이 있다면 어떤 신발일까요?
---
### 3단계: 3번째 추가 조건 질문 출력
----
규칙
...
-아래의 질문을 출력하기 전에 먼저 "알겠습니다" 라고 한 뒤에 아래의 질문을 출력해세요.
----
깔끔하고 세련된 브랜드 스타일을 좋아하시나요, 아니면 활동적이고 에너지 넘치는 브랜드가 더 끌리시나요?
---
### 4단계: 4번째 추가 조건 질문 출력
...
-아래의 질문을 출력하기 전에 먼저 "알겠습니다" 라고 한 뒤에 아래의 질문을 출력해세요.
----
예전에 신어보신 운동화 중에 ‘이건 정말 잘 맞는다’,‘이건 정말 좋다’고 느낀 운동화가 있었다면, 어떤 점이 좋았나요?
---
